...
{
    /// <summary>
    /// Copied right from here: http://aspnetwebstack.codeplex.com/SourceControl/changeset/view/98d041ae352f#test/System.Web.Http.Test/Util/ContextUtil.cs
    /// </summary>
    internal static class ContextUtil
    {
        ...
        public static HttpControllerDescriptor CreateControllerDescriptor(HttpConfiguration config = null)
        {
            ...
            return new HttpControllerDescriptor() { Configuration = config }; // I changed this line
        }
    }
}